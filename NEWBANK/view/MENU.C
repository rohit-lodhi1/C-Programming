...
// user pending list menu

 void pendingListMenu()
 {
   
     clrscr();
   printf("\033[1;36m");
   newLine(3);
   printf("%49.20s","User Pending List\n");
     lineDesigne();
   newLine(4);
   printf("\033[1;37m");
   printf("%35.20s","1. View Pending Users");
   printf("%32.20s","2. Acitve user");
 }

 //User Mini Statement

 void miniStatementMenu(){

      clrscr();
   printf("\033[1;36m");
   newLine(3);
   printf("%49.20s","Mini Statement\n");
  lineDesigne();
   printf("\033[1;37m");
   printf("%23s","Transactions");
   printf("%34s","Amount");
   printf("%17s","Balance");
 }